...
def train(args, model):
    ...
    train_df = pd.read_csv(args.train_path + "train_df.csv")
    val_df = pd.read_csv(args.train_path + "val_df.csv")

    # create HuggingFace Dataset
    dataset = create_dataset(train_df, val_df)

    args = Seq2SeqTrainingArguments(
        f"{args.output_path}finetuned-content-to-title",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_path", help="path to train dataet", default="data/")
    parser.add_argument("--output_path", help="path to save model", default="src/models/")
